...
2. Open the WhatsApp account where you want to create the bot and go into the link device and SCAN the QR code Click [SCAN](https://repl.it/badge/github/quiec/whatsasena)
...
## Developer
  ...
  [![`Ameer Suhail`](https://github.com/Mastermintermt.png?size=200)](https://github.com/ameer-kallumthodi)
